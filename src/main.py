from ImagePryamid import ImagePyramid
import numpy as np
import cv2
image_left = cv2.imread(r"C:\Users\MONSTER\GitHub\PanoromeImageCreator\src\im1.jpg")
image_right = cv2.imread(r"C:\Users\MONSTER\GitHub\PanoromeImageCreator\src\im2.jpg")
image_pyramid_left = ImagePyramid(image_left, 5, 2, 3, "left")
image_pyramid_right = ImagePyramid(image_right, 5, 2, 3, "right")
